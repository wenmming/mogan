...
inline void
tmscm_set_car (tmscm a, tmscm b) {
  s7_set_car (a, b);
}
inline void
tmscm_set_cdr (tmscm a, tmscm b) {
  s7_set_cdr (a, b);
}

inline bool
tmscm_is_equal (tmscm o1, tmscm o2) {
  return s7_is_equal (tm_s7, o1, o2);
}

inline bool
tmscm_is_null (tmscm obj) {
  return s7_is_null (tm_s7, obj);
}
inline bool
tmscm_is_pair (tmscm obj) {
  return s7_is_pair (obj);
}
inline bool
tmscm_is_list (tmscm obj) {
  return s7_is_list (tm_s7, obj);
}
inline bool
tmscm_is_bool (tmscm obj) {
  return s7_is_boolean (obj);
}
inline bool
tmscm_is_int (tmscm obj) {
  return s7_is_integer (obj);
}
inline bool
tmscm_is_double (tmscm obj) {
  return s7_is_real (obj);
}
inline bool
tmscm_is_string (tmscm obj) {
  return s7_is_string (obj);
}
inline bool
tmscm_is_symbol (tmscm obj) {
  return s7_is_symbol (obj);
}

inline tmscm
tmscm_cons (tmscm obj1, tmscm obj2) {
  return s7_cons (tm_s7, obj1, obj2);
}
inline tmscm
tmscm_car (tmscm obj) {
  return s7_car (obj);
...
inline tmscm
tmscm_caar (tmscm obj) {
  return s7_caar (obj);
}
inline tmscm
tmscm_cadr (tmscm obj) {
  return s7_cadr (obj);
}
inline tmscm
tmscm_cdar (tmscm obj) {
  return s7_cdar (obj);
}
inline tmscm
tmscm_cddr (tmscm obj) {
  return s7_cddr (obj);
}
inline tmscm
tmscm_caddr (tmscm obj) {
  return s7_caddr (obj);
}
inline tmscm
tmscm_cadddr (tmscm obj) {
  return s7_cadddr (obj);
}

inline tmscm
bool_to_tmscm (bool b) {
  return (b ? s7_t (tm_s7) : s7_f (tm_s7));
}
inline tmscm
int_to_tmscm (int i) {
  return s7_make_integer (tm_s7, i);
}
inline tmscm
long_to_tmscm (long l) {
  return s7_make_integer (tm_s7, l);
}
inline tmscm
...
tmscm_to_bool (tmscm obj) {
  return s7_boolean (tm_s7, obj);
}
inline int
tmscm_to_int (tmscm obj) {
  return s7_integer (obj);
}
inline double
...
#define TMSCM_ASSERT(_cond, _arg, _pos, _subr)                                 \
  do {                                                                         \
    if (TMSCM_UNLIKELY (!(_cond)))                                             \
      s7_wrong_type_arg_error (tm_s7, _subr, _pos, _arg, "some other thing");  \
  } while (0)
